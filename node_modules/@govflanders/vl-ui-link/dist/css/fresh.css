...
.vl-link {
  ...
  .vl-link:hover {
    color: #003bb0;
    -webkit-box-shadow: inset 0 -0.1rem rgba(0, 59, 176, 0.2);
            box-shadow: inset 0 -0.1rem rgba(0, 59, 176, 0.2); }
  .vl-link:focus, .vl-link:active {
    color: #004099;
    -webkit-box-shadow: inset 0 -0.1rem rgba(0, 64, 153, 0.2);
            box-shadow: inset 0 -0.1rem rgba(0, 64, 153, 0.2); }
  .vl-link--bold {
    font-weight: 500;
