...
button:focus {
  outline: 0;
  -webkit-box-shadow: 0 0 0 2px #fff, 0 0 0 5px rgba(0, 85, 204, 0.65);
...
.js .vl-accordion__content {
  ...
  max-height: 0;
  overflow: hidden;
  -webkit-transition: max-height 0.3s cubic-bezier(0, 1.05, 0, 1), overflow 0s 0s;
...
.js .js-vl-accordion--open > .vl-accordion__content {
  ...
  max-height: 1000vh;
  overflow: visible;
  -webkit-transition: max-height 0.3s, overflow 0s 0.3s;
...
.vl-button {
  ...
  .vl-button--loading {
    ...
    .vl-button--loading::after {
      ...
      background-color: #cbd2d9;
      border-radius: 50%;
      -webkit-box-shadow: 1rem 0 #fff, 2rem 0 #fff, 3rem 0 #fff;
              box-shadow: 1rem 0 #fff, 2rem 0 #fff, 3rem 0 #fff; }

@-webkit-keyframes waving-light {
  0% {
    -webkit-box-shadow: 10px 0px #8695a8, 20px 0px #8695a8, 30px 0px #8695a8;
            box-shadow: 10px 0px #8695a8, 20px 0px #8695a8, 30px 0px #8695a8; }
  10% {
    -webkit-box-shadow: 10px -3px #8695a8, 20px 0px #8695a8, 30px 0px #8695a8;
            box-shadow: 10px -3px #8695a8, 20px 0px #8695a8, 30px 0px #8695a8; }
  20% {
    -webkit-box-shadow: 10px -6px #8695a8, 20px -3px #8695a8, 30px 0px #8695a8;
            box-shadow: 10px -6px #8695a8, 20px -3px #8695a8, 30px 0px #8695a8; }
  30% {
    -webkit-box-shadow: 10px -3px #8695a8, 20px -6px #8695a8, 30px -3px #8695a8;
            box-shadow: 10px -3px #8695a8, 20px -6px #8695a8, 30px -3px #8695a8; }
  40% {
    -webkit-box-shadow: 10px 0px #8695a8, 20px -3px #8695a8, 30px -6px #8695a8;
            box-shadow: 10px 0px #8695a8, 20px -3px #8695a8, 30px -6px #8695a8; }
  50% {
    -webkit-box-shadow: 10px 0px #8695a8, 20px 0px #8695a8, 30px -3px #8695a8;
            box-shadow: 10px 0px #8695a8, 20px 0px #8695a8, 30px -3px #8695a8; }
  60% {
    -webkit-box-shadow: 10px 0px #8695a8, 20px 0px #8695a8, 30px 0px #8695a8;
            box-shadow: 10px 0px #8695a8, 20px 0px #8695a8, 30px 0px #8695a8; }
  100% {
...
.vl-link {
  ...
  cursor: pointer;
  text-decoration: none;
  -webkit-box-shadow: inset 0 -0.1rem #05c;
          box-shadow: inset 0 -0.1rem #05c; }
  .vl-link:hover {
    color: #003bb0;
    -webkit-box-shadow: inset 0 -0.1rem #003bb0;
            box-shadow: inset 0 -0.1rem #003bb0; }
  .vl-link:focus, .vl-link:active {
    color: #004099;
    -webkit-box-shadow: inset 0 -0.1rem #004099;
            box-shadow: inset 0 -0.1rem #004099; }
  .vl-link--bold {
    font-weight: 500;
  ...
  .vl-link--block {
    display: table; }
    .vl-link--block::before, .vl-link--block::after {
      display: table;
      clear: both;
      overflow: hidden;
      content: ""; }
...
.vl-toggle {
  position: relative; }
  .vl-toggle__icon.vl-vi {
    font-size: 1rem; }
    .vl-toggle__icon.vl-vi::before, .vl-toggle__icon.vl-vi::after {
      color: #333332; }
    .vl-toggle__icon.vl-vi::before {
      -webkit-transition: -webkit-transform 0.2s;
      transition: -webkit-transform 0.2s;
      transition: transform 0.2s;
      transition: transform 0.2s, -webkit-transform 0.2s; }
  .js-vl-accordion--open > .vl-toggle .vl-vi-arrow-right-fat::before, .js-vl-accordion--open >
  .vl-toggle .vl-vi-arrow-right-thin::before {
    -webkit-transform: rotate(90deg);
            transform: rotate(90deg); }
...
@media screen and (min-width: 1023.1px) {
  ...
  .vl-u-flex-align-right--l {
    -webkit-box-align: end !important;
        -ms-flex-align: end !important;
            align-items: flex-end !important; }
  .vl-u-flex-space-between--l {
    -webkit-box-align: space-between !important;
        -ms-flex-align: space-between !important;
            align-items: space-between !important; }
  .vl-u-flex-space-around--l {
    -webkit-box-align: space-around !important;
        -ms-flex-align: space-around !important;
            align-items: space-around !important; }
  .vl-u-flex-v-top--l {
...
@media screen and (max-width: 1023px) {
  ...
  .vl-u-flex-align-right--m {
    -webkit-box-align: end !important;
        -ms-flex-align: end !important;
            align-items: flex-end !important; }
  .vl-u-flex-space-between--m {
    -webkit-box-align: space-between !important;
        -ms-flex-align: space-between !important;
            align-items: space-between !important; }
  .vl-u-flex-space-around--m {
    -webkit-box-align: space-around !important;
        -ms-flex-align: space-around !important;
            align-items: space-around !important; }
  .vl-u-flex-v-top--m {
...
@media screen and (max-width: 767px) {
  ...
  .vl-u-flex-align-right--s {
    -webkit-box-align: end !important;
        -ms-flex-align: end !important;
            align-items: flex-end !important; }
  .vl-u-flex-space-between--s {
    -webkit-box-align: space-between !important;
        -ms-flex-align: space-between !important;
            align-items: space-between !important; }
  .vl-u-flex-space-around--s {
    -webkit-box-align: space-around !important;
        -ms-flex-align: space-around !important;
            align-items: space-around !important; }
  .vl-u-flex-v-top--s {
...
@media screen and (max-width: 500px) {
  ...
  .vl-u-flex-align-right--xs {
    -webkit-box-align: end !important;
        -ms-flex-align: end !important;
            align-items: flex-end !important; }
  .vl-u-flex-space-between--xs {
    -webkit-box-align: space-between !important;
        -ms-flex-align: space-between !important;
            align-items: space-between !important; }
  .vl-u-flex-space-around--xs {
    -webkit-box-align: space-around !important;
        -ms-flex-align: space-around !important;
            align-items: space-around !important; }
  .vl-u-flex-v-top--xs {
...
.vl-u-mark {
  -webkit-box-shadow: inset 0 -10px 0 0 rgba(255, 197, 21, 0.3);
          box-shadow: inset 0 -10px 0 0 rgba(255, 197, 21, 0.3); }

.vl-u-mark--accent {
  -webkit-box-shadow: inset 0 -10px 0 0 rgba(255, 230, 21, 0.3);
          box-shadow: inset 0 -10px 0 0 rgba(255, 230, 21, 0.3); }

.vl-u-mark--info {
  -webkit-box-shadow: inset 0 -10px 0 0 rgba(203, 210, 218, 0.4);
          box-shadow: inset 0 -10px 0 0 rgba(203, 210, 218, 0.4); }

.vl-u-mark--success {
  -webkit-box-shadow: inset 0 -10px 0 0 rgba(60, 168, 84, 0.2);
          box-shadow: inset 0 -10px 0 0 rgba(60, 168, 84, 0.2); }

.vl-u-mark--warning {
  -webkit-box-shadow: inset 0 -10px 0 0 rgba(255, 197, 21, 0.2);
          box-shadow: inset 0 -10px 0 0 rgba(255, 197, 21, 0.2); }

.vl-u-mark--error {
  -webkit-box-shadow: inset 0 -10px 0 0 rgba(219, 52, 52, 0.2);
